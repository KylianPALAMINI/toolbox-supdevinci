...
class CVEScannerApp:
    def __init__(self, root):
        ...
        # dossier temporaire rapports intermédiaires
    ...
    def generate_service_description(self, service_name):
        ...
        try:
            ...
            if "Désolé" in description and "ne peux pas fournir" in description:
    ...
    def generate_cve_recommendation(self, cve_id):
        ...
        try:
            ...
            if "Désolé" in recommendation and "ne peux pas fournir" in recommendation:
    ...
    def generate_report(self, services, cve_data, base_dir):
        ...
        # enregistrmeent du rapport dans le dossier temp
        temp_report_path = os.path.join(self.temp_dir, f"rapport_scan_cve_{timestamp}_{unique_id}.docx")
    ...
    def finalize_scan(self, report_path):
        ...
        # ouverture du répertoire contenant le rapport
