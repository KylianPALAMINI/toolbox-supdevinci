...
class ConnectionSpeedTestApp:
    def __init__(self, root):
        ...
        # Ajouter l'icône
        icon_path = "F:/Documents/07_projet_python/programmes_ok/logos/test_connection.ico"
    ...
    def stop_tests(self):
        # Implémentez cette fonction si vous voulez ajouter la possibilité d'arrêter les tests
        pass
