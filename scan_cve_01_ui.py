...
class CVEScannerApp:
    def __init__(self, root):
        ...
        # Ajouter le logo
        icon_path = "F:/Documents/07_projet_python/programmes_ok/logos/scan_cve.ico"
    ...
    def generate_service_description(self, service_name):
        ...
        try:
            ...
            if "Désolé" in description or "ne peux pas fournir" in description:
    ...
    def generate_cve_recommendation(self, cve_id):
        ...
        try:
            ...
            if "Désolé" in recommendation or "ne peux pas fournir" in recommendation:
    ...
    def stop_scan(self):
        # Implémentez cette fonction si vous voulez ajouter la possibilité d'arrêter le scan
        pass
